defmodule TodosWeb.TaskLiveTest do
  ...
  @create_attrs %{taskitem: "some taskitem"}
  @update_attrs %{taskitem: "some updated taskitem"}
  @invalid_attrs %{taskitem: nil}
  ...
  describe "Index" do
    ...
    test "updates task in listing", %{conn: conn, task: task} do
      ...
      assert html =~ "some updated taskitem"
    end
